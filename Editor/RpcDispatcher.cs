			...
			else if ( method == "tools/call" )
			{
				...
				else
				{
					...
					result = toolName switch
					{
						...
						// ── Rendering tools ──────────────────────────────────────────────────
						"create_text_renderer"       => RenderingToolHandlers.CreateTextRenderer( args ),
						"create_line_renderer"       => RenderingToolHandlers.CreateLineRenderer( args ),
						"create_sprite_renderer"     => RenderingToolHandlers.CreateSpriteRenderer( args ),
						"create_trail_renderer"      => RenderingToolHandlers.CreateTrailRenderer( args ),
						"create_model_renderer"      => RenderingToolHandlers.CreateModelRenderer( args ),
						"create_skinned_model"       => RenderingToolHandlers.CreateSkinnedModel( args ),
						"create_screen_panel"        => RenderingToolHandlers.CreateScreenPanel( args ),
						// ── Game tools ──────────────────────────────────────────────────────
						"create_spawn_point"         => GameToolHandlers.CreateSpawnPoint( args ),
						"create_trigger_hurt"        => GameToolHandlers.CreateTriggerHurt( args ),
						"create_envmap_probe"        => GameToolHandlers.CreateEnvmapProbe( args ),
						"create_prop"                => GameToolHandlers.CreateProp( args ),
						"create_decal"               => GameToolHandlers.CreateDecal( args ),
						"create_world_panel"         => GameToolHandlers.CreateWorldPanel( args ),
						"create_fire_damage"         => GameToolHandlers.CreateFireDamage( args ),
						"create_hitbox"              => GameToolHandlers.CreateHitbox( args ),
						"create_chair"               => GameToolHandlers.CreateChair( args ),
						"create_dresser"             => GameToolHandlers.CreateDresser( args ),
						"create_gib"                 => GameToolHandlers.CreateGib( args ),
